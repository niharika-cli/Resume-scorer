...
2. Update the `job_description` variable in the script with the job you're hiring for
3. Run the script:
...
```
Processing: niharika_software_engineer.pdf
Score: 82.0

Processing: niharika_sre.docx
Score: 91.0
