...
Design and maintain alerting strategies (reduce noise, improve signal)
Improve Mean Time to Detect (MTTD) through better monitoring
Standardize dashboard and alert templates
